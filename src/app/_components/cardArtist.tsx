...
export function CardArtist({ artist }: { artist: Artist }) {
    return (
        <>
            <div className="group relative flex flex-col items-center justify-center gap-1 px-3 py-3 sm:px-4 sm:py-4 rounded-2xl sm:rounded-3xl w-full aspect-square sm:aspect-auto
              ...
              hover:shadow-[0_0_36px_8px_rgba(236,72,153,0.45)] hover:scale-105 transition-all duration-300 cursor-default">
                ...
                <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-pink-300/80 text-center line-clamp-2">
                    {artist.genres.join(", ")}
                </p>
                <a
