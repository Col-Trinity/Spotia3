...
export default function MenuToggle({ setButtonClose,locale, onRefresh}: Props) {
    ...
    return (
        <div className="fixed top-0 left-0 z-20 w-[30vh] h-[100vh] bg-[rgb(235,231,255)] flex flex-col">
            ...
            <div className="flex flex-col items-start mt-[100%] px-4 gap-4 font-semibold text-lg text-[rgb(77,74,94)]">
                <button onClick={()=>router.push(`/es/dashboar`)} className=" hover:bg-[rgb(215,206,253)] p-2 mb-4 mx-4 rounded-xl">Inicio</button>
