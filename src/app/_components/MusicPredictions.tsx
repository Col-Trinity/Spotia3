...
export function MusicPredictions({responseIa}:Props){
  ...
  <div className="flex   gap-4 mt-6 justify-center">
    ...
    <div className="group relative flex flex-col items-center gap-2 px-6 py-5 rounded-3xl min-w-32
      ...
      <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-purple-300/80">Alineación</span>
    ...
    <div className="group relative flex flex-col items-center gap-2 px-6 py-5 rounded-3xl min-w-32
      ...
      <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-violet-300/80">Higiene</span>
    ...
    <div className="group relative flex flex-col items-center gap-2 px-6 py-5 rounded-3xl min-w-32
      ...
      hover:shadow-[0_0_36px_8px_rgba(108,99,255,0.45)] hover:scale-105 transition-all duration-300 cursor-default">
      <span className="text-3xl">🗳️</span>
      <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-fuchsia-300/80">Tendencia</span>
