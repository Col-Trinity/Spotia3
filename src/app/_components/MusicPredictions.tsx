  ...
  return (
    <div className="flex flex-wrap gap-4 mt-6 justify-center">
      ...
      <div className="group relative flex flex-col items-center gap-1 px-4 py-3 sm:px-6 sm:py-5 rounded-3xl w-[45%] sm:w-auto sm:min-w-32
        ...
        <span className="text-[9px] sm:text-[10px] font-bold uppercase tracking-[0.2em] text-purple-300/80">{t("alignment")}</span>
      ...
      <div className="group relative flex flex-col items-center gap-1 px-4 py-3 sm:px-6 sm:py-5 rounded-3xl w-[45%] sm:w-auto sm:min-w-32
        ...
        <span className="text-[9px] sm:text-[10px] font-bold uppercase tracking-[0.2em] text-violet-300/80">{t("hygiene")}</span>
      ...
      <div className="group relative flex flex-col items-center gap-1 px-4 py-3 sm:px-6 sm:py-5 rounded-3xl w-[45%] sm:w-auto sm:min-w-32
        ...
        hover:shadow-[0_0_36px_8px_rgba(108,99,255,0.45)] hover:scale-105 transition-all duration-300 cursor-default">
        <span className="text-2xl sm:text-3xl">🗳️</span>
        <span className="text-[9px] sm:text-[10px] font-bold uppercase tracking-[0.2em] text-fuchsia-300/80">{t("tendency")}</span>
