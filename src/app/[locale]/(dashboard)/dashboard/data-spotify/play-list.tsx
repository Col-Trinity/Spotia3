...
export function Playlist() {
  ...
  const {
    ...
    error: errorPlayList,
  } = useFetchQuery<PlaylistItem[]>("playlists", "/api/spotify/play-list");
  ...
  const {
    ...
    effectivePlaylistId
      ? `/api/spotify/play-list/${effectivePlaylistId}/tracks`
      : "",
      ...
      <div className="px-4 py-5">
        ...
        <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
          {[1, 2, 3, 4].map((i) => (
            <div
              key={i}
              className="shrink-0 w-32 sm:w-36 bg-pink-50 rounded-2xl p-3 animate-pulse"
            >
